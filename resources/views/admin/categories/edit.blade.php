...
@section('title', __('admin/categories.edit_category'))
...
@section('content_header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('admin/categories.edit_category') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ __('admin/categories.edit_category') }}</li>
                    </ol>
                </div>
            </div>
        </div>
