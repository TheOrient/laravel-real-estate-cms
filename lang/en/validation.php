...
return [
    ...
    */
    ...
    | the "attribute.rule" syntax. This makes it quick to specify a custom
    | language line for a specific attribute rule.
    |
    */
    ...
    | of "email". This helps make our messages more expressive.
    |
    */
